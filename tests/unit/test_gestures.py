...
class TestCountOpenFingers:
    ...
    def test_one_finger_extended(self):
        ...
        landmarks = [
            ...
            [5, 260, 220], [6, 270, 180], [7, 275, 140], [8, 280, 100],  # Index open
...
class TestIsOpenHand:
    ...
    def test_partial_open_not_open_hand(self):
        ...
        landmarks = [
            [0, 250, 250],
            [1, 240, 240], [2, 235, 235], [3, 230, 230], [4, 225, 225],
            [5, 260, 220], [6, 270, 180], [7, 275, 140], [8, 280, 100],
            [9, 280, 240], [10, 283, 245], [11, 285, 250], [12, 287, 255],
            [13, 300, 240], [14, 303, 245], [15, 305, 250], [16, 307, 255],
            [17, 320, 240], [18, 323, 245], [19, 325, 250], [20, 327, 255],
        ]
